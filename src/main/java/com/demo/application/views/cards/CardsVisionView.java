...
@Route(value="cards/vision", layout=MainLayout.class)
@PageTitle("Cards Vision")
public class CardsVisionView  extends VerticalLayout {
        public CardsVisionView() {
        ...
        private Div createServiceCard(String title) {
            ...
            switch (title) {
                ...
                Image svgImage2 = new Image("./images/dental-card.png", "dental card");
                ...
                Image svgImage4 = new Image("./images/prescription-card.png", "prescription card");
                ...
                Image svgImage5 = new Image("./images/health-navigator-card.png", "health navigator card");
