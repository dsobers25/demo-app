...
@Route(value="cards/prescription-savings", layout=MainLayout.class)
@PageTitle("Cards Prescription Savings")
public class CardsPrescriptionSavingsView  extends VerticalLayout {
            public CardsPrescriptionSavingsView() {
